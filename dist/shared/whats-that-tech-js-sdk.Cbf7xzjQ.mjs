...
import fsPromises, { readFile, readdir } from 'fs/promises';
...
import { c as commonjsGlobal } from './whats-that-tech-js-sdk.BFTU3MAI.mjs';
  ...
  if (customFile) {
    ...
    try {
      ...
      if (isUrl(customFile)) {
        ...
        const resolvedPath = resolve(process.cwd(), customFile);
...
export { FormData as F, File as a, findTech as f };
